    ...
    <div className="min-h-screen pt-16 bg-slate-950">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 relative z-10">
          ...
          <div className="glass-card rounded-2xl p-8 mb-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {instruments.map((inst, i) => (
                <div key={i} className="bg-slate-800/50 rounded-xl p-4 hover:bg-slate-800/70 transition-colors">
                  <div className="font-semibold text-lg mb-2">{inst.symbol}</div>
                  <div className="flex justify-between text-sm text-slate-400">
                    <span>{t("spread")}: <span className="text-cyan-400">{inst.spread}</span></span>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="glass-card rounded-2xl p-6 text-center">
              ...
              <p className="text-slate-400">{t("instantExecutionDesc")}</p>
            </div>
            <div className="glass-card rounded-2xl p-6 text-center">
              <div className="text-4xl mb-4">🔒</div>
              <h3 className="text-xl font-bold mb-2">{t("secureTrading")}</h3>
              <p className="text-slate-400">{t("secureTradingDesc")}</p>
            </div>
            <div className="glass-card rounded-2xl p-6 text-center">
              <div className="text-4xl mb-4">📊</div>
              <h3 className="text-xl font-bold mb-2">{t("realtimeQuotes")}</h3>
              <p className="text-slate-400">{t("realtimeQuotesDesc")}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <section className="py-16 bg-gradient-to-b from-slate-900/50 to-transparent">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-slate-400 mb-8">{t("openAccountDesc")}</p>
