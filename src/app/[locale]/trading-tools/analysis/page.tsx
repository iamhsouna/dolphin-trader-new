    ...
    <div className="min-h-screen pt-16 bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="glass-card rounded-xl p-6 mb-8">
          ...
          <div className="bg-slate-800/50 rounded-xl h-80 flex items-center justify-center mb-6">
            <div className="text-center">
              <div className="text-6xl mb-4">📈</div>
              <p className="text-slate-400">{t("chartPatterns")}</p>
              <p className="text-slate-500 text-sm mt-2">{t("poweredByTradingView")}</p>
            </div>
          </div>

          <div className="flex flex-wrap gap-2">
            {["1H", "4H", "D1", "W1", "M1"].map((tf) => (
              <button key={tf} className="px-4 py-2 bg-slate-800/50 rounded-lg text-sm hover:bg-slate-700/50">
                {tf}
              </button>
            ))}
          </div>
              ...
              {[
                ...
                <div key={i} className="flex items-center justify-between py-2 border-b border-slate-700/50 last:border-0">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-xs text-cyan-400">{ind.signal}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="glass-card rounded-xl p-6">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex items-center justify-between py-2 border-b border-slate-700/50 last:border-0">
                  <span className={`text-sm ${level.type === "Resistance" ? "text-red-400" : "text-green-400"}`}>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex items-center justify-between py-2 border-b border-slate-700/50 last:border-0">
                  ...
                  <div className="text-right">
                    <div className="text-cyan-400 text-sm">{p.confidence}</div>
                    <div className={`text-xs ${p.direction === "Bullish" ? "text-green-400" : "text-red-400"}`}>
                      {p.direction}
                    </div>
                  </div>
                </div>
