...
export default function DepositPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    alert(`Deposit of $${amount} via ${method} submitted!`);
  };
    ...
    <div className="min-h-screen pt-16 bg-background">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">{t("fundAccount")}</p>
        </div>
        ...
        <div className="mt-8 glass-card rounded-xl p-6">
          <h3 className="text-lg font-bold mb-4">{t("depositLabel")}</h3>
          <div className="space-y-3 text-sm text-muted-foreground">
            <p>• {t("minDepositMessage")}</p>
            <p>• {t("processingTimeMessage")}</p>
