      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          <div className="glass-card rounded-xl p-6 text-center">
            ...
            <p className="text-slate-400">{t("chooseDescription")}</p>
          </div>
          <div className="glass-card rounded-xl p-6 text-center">
            <div className="text-4xl mb-4">⚡</div>
            <h3 className="text-xl font-bold mb-2">{t("instantCopy")}</h3>
            <p className="text-slate-400">{t("instantCopyDesc")}</p>
          </div>
          <div className="glass-card rounded-xl p-6 text-center">
            <div className="text-4xl mb-4">💰</div>
            <h3 className="text-xl font-bold mb-2">{t("fullControl")}</h3>
            <p className="text-slate-400">{t("fullControlDesc")}</p>
          </div>
        </div>
          ...
          {masterTraders.map((trader) => (
            <div key={trader.id} className="glass-card rounded-xl p-6 hover-lift">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-cyan-500 to-blue-500 flex items-center justify-center text-xl font-bold text-slate-900">
                  {trader.avatar}
                </div>
                <div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="text-center">
                  ...
                  <div className="text-xs text-slate-400">{t("roi")}</div>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-slate-400">{t("drawdown")}</div>
                </div>
                <div className="text-center">
                  <div className="text-lg font-bold">{trader.trades.toLocaleString()}</div>
                  <div className="text-xs text-slate-400">{t("totalTrades")}</div>
                </div>
              </div>
        ...
        <section className="mt-16 py-16 bg-gradient-to-r from-cyan-900/30 to-purple-900/30 rounded-2xl">
