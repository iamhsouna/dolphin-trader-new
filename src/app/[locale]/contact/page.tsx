            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select className="w-full bg-slate-800/50 border border-slate-700 rounded-lg px-4 py-2">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  className="w-full bg-slate-800/50 border border-slate-700 rounded-lg px-4 py-3 resize-none"
                />
              </div>
              ...
              <div className="space-y-4">
                {offices.map((office, i) => (
                  <div key={i} className="flex justify-between items-center py-3 border-b border-slate-700/50 last:border-0">
                    ...
                    <span className="text-cyan-400 text-sm">{office.email}</span>
                  </div>
                ))}
              </div>
            </div>
