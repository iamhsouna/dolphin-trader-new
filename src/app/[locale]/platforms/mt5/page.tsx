    ...
    <div className="min-h-screen pt-16 bg-slate-950">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-cyan-500/10 border border-cyan-500/30 rounded-full px-4 py-2 mb-6">
                <span className="text-cyan-400 text-sm font-medium">{t("industryStandard")}</span>
              </div>
            ...
            <div className="relative">
              <div className="glass-card rounded-2xl p-4 bg-slate-900/80">
                <Image
                  src="/logo.png"
                  alt="MT5 Platform"
                  width={600}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="glass-card rounded-xl p-8 text-center hover-lift">
              ...
              <p className="text-slate-400 text-sm mb-6">{t("metaTrader5")} for Windows</p>
            ...
            <div className="glass-card rounded-xl p-8 text-center hover-lift">
              ...
              <p className="text-slate-400 text-sm mb-6">MetaTrader 5 for iPhone/iPad</p>
            ...
            <div className="glass-card rounded-xl p-8 text-center hover-lift">
              ...
              <p className="text-slate-400 text-sm mb-6">MetaTrader 5 for Android</p>
              <button onClick={() => setShowModal(true)} className="btn-secondary w-full">
                {t("googlePlayStore")}
              </button>
            </div>
      ...
      <section className="py-16 bg-gradient-to-b from-slate-900/50 to-transparent">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-3xl font-bold mb-4">{t("readyToStart") || "Ready to Start Trading?"}</h2>
          <p className="text-slate-400 mb-8">
            Open your account in minutes and start trading with MetaTrader 5
          </p>
