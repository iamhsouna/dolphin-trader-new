        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-purple-500/10 border border-purple-500/30 rounded-full px-4 py-2 mb-6">
              <span className="text-purple-400 text-sm font-medium">{t("noDownloadRequired")}</span>
            </div>
            ...
            <button className="btn-primary text-lg px-10 py-5 shadow-lg shadow-purple-500/30">
              🚀 {t("launchWebTrader")}
            </button>
          ...
          <div className="glass-card rounded-2xl p-8 max-w-4xl mx-auto bg-slate-900/80">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm text-slate-400">WebTrader - EUR/USD</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-2 h-2 bg-green-400 rounded-full animate-pulse" />
                <span className="text-xs text-green-400">{t("connected")}</span>
              </div>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-xl h-64 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-slate-400">{t("chartPlaceholder")}</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="glass-card rounded-2xl p-8">
              <div className="grid grid-cols-3 gap-4 text-center">
                <div className="p-4">
                  ...
                  <div className="text-sm text-slate-400">{t("desktop")}</div>
                </div>
                <div className="p-4">
                  <div className="text-4xl mb-2">💻</div>
                  <div className="text-sm text-slate-400">{t("laptop")}</div>
                </div>
                <div className="p-4">
                  <div className="text-4xl mb-2">📱</div>
                  <div className="text-sm text-slate-400">{t("tablet")}</div>
                </div>
              </div>
              <div className="mt-6 p-4 bg-slate-800/50 rounded-xl text-center">
                ...
                <div className="flex justify-center gap-4 mt-2">
                  {["Chrome", "Firefox", "Safari", "Edge"].map((browser) => (
                    <span key={browser} className="text-xs text-slate-500">{browser}</span>
                  ))}
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-gradient-to-b from-slate-900/50 to-transparent">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button className="btn-primary text-lg px-10 py-5 shadow-lg shadow-cyan-500/30">
